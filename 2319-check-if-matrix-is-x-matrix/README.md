<h2><a href="https://leetcode.com/problems/check-if-matrix-is-x-matrix/?envType=problem-list-v2&envId=matrix">2319. Check if Matrix Is X-Matrix</a></h2><h3>Easy</h3><hr><p>A square matrix is said to be an <strong>X-Matrix</strong> if <strong>both</strong> of the following conditions hold:</p>
